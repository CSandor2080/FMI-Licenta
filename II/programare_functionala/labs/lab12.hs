...
-- 1. Implementat,i următoarele funct,ii folosind foldMap s, i/sau foldr din clasa Foldable,
-- apoi testat,i-le cu mai multe tipuri care au instant,ă pentru Foldable
